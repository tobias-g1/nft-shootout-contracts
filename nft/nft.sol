...
/// @custom:security-contact contact@nftshootout.com
contract NFTShooutout is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable, ContextMixin {
    ...
    constructor(string memory _name, string memory _symbol, uint256 _maxSupply, string memory _uri) ERC721(_name, _symbol) {
    ...
    function setBaseUri(string memory _uri) public onlyOwner{
        require(canUpdateUri = true, "Base Uri has been locked");
        baseUri = _uri;
    }
 ...
 function tokenURI(uint256 _tokenId) public view virtual override(ERC721, ERC721URIStorage) returns (string memory){
     require(_exists(_tokenId), "ERC721Metadata: URI query for nonexistent token");
      ...
      return string(abi.encodePacked(currentBaseURI, Strings.toString(_tokenId), uriSuffix));
    }
